...
qp, xTp, fval= prod_fun(labor_input+1e-5*[1;0;0], θ, κ, z, αVec; initial_guess=initial_guess,  x_tol=1e-10)

MPLp=margProdLabor(labor_input+1e-5*[1;0;0], θ, κ, z, αVec, xTp, qp)
MPL
(qp-q)*1e5
(MPLp-MPL)*1e5
...
>>>>>>> fb897f423aed698161b137e8966205f6052b87eb
